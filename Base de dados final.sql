...
--
-- Host: 127.0.0.1
-- Tempo de geração: 27-Nov-2021 às 21:31
...
--
-- Banco de dados: `itard`
--

-- --------------------------------------------------------

--
-- Estrutura da tabela `conteudodaspaginas`
--

CREATE TABLE `conteudodaspaginas` (
...
--
-- Extraindo dados da tabela `conteudodaspaginas`
--

INSERT INTO `conteudodaspaginas` (`cd_conteudo`, `titulo`, `texto`) VALUES
(2, 'Anorexia', '<p style=\"color:red\">É IMPORTANTE ENFATIZAR A PROCURA POR ESPECIALISTAS E PROFISSIONAIS NA ÁREA, CASO VOCÊ SINTA QUALQUER DOS SINTOMAS, PROCURE UM PROFISSIONAL PRÓXIMO.</p>\r\nAnorexia nervosa, ou simplesmente anorexia, é um transtorno alimentar caracterizado pela restrição de ingestão calórica em uma quantidade saudável, seja por medo de engordar ou por não conseguir reconhecer a sua situação física.\r\n<br> <br>\r\nPessoas com anorexia normalmente se encontram com pesos extremamente e reduzidos, não conseguindo aumentar o seu peso. Por conta do aspecto físico, esses indivíduos podem apresentar alguns sintomas depressivos, como humor deprimido, isolamento social, irritabilidade, insônia e diminuição de libido. Normalmente, os anoréxicos negam a existência de um problema, dizem que é normal e só estão um pouco abaixo do peso.\r\n\r\n<br> <br>\r\n\r\nNormalmente, os sintomas da anorexia surgem no período da adolescência, em momentos de muito estresse na vida dessa pessoa. Normalmente, é nesse período que as pessoas tendem a querer ser “bonitas”, a seguir os padrões de beleza impostos na sociedade, tanto que os anoréxicos tendem a passar muito tempo de frente para o espelho, assim o individuo acaba fazendo de tudo para emagrecer e evitar ganhar peso. Podem aparecer por predisposição genética e por alterações neuroquímicas cerebrais.\r\n<br>\r\n'),
(3, 'Ansiedade', '<p style=\"color:red\">É IMPORTANTE ENFATIZAR A PROCURA POR ESPECIALISTAS E PROFISSIONAIS NA ÁREA, CASO VOCÊ SINTA QUALQUER DOS SINTOMAS, PROCURE UM PROFISSIONAL PRÓXIMO.</p>\r\nAnsiedade é algo relativamente normal na vida das pessoas, todo mundo já se sentiu ansioso em algum momento da sua vida, porém, deve-se diferenciar a ansiedade comum do transtorno de ansiedade, onde a diferença principal é a intensidade e a duração dos sintomas, esses que são:\r\n<br>\r\n-Preocupações, medos ou tensões exageradas;<br>\r\n-Sensação de desastre; <br>\r\n-Medo extremo de alguma coisa ou de alguma situação; <br>\r\n-Falta de controle sobre os seus pensamentos. <br><br>\r\n\r\nTambém existem diversos tipos de transtornos de ansiedade, sendo esses: <br>\r\n-Transtorno de Ansiedade Generalizada (TAG): É o tipo mais comum, onde o paciente se encontra frequentemente ansioso, as vezes sem nenhuma razão específica. O desconforto causado pode ser tão grande que pode dar uma sensação de cansaço e uma dificuldade de concentração. Sintomas como insônia também são comuns. <br>\r\n-Fobias: Os sintomas de uma fobia são os mesmos dos outros tipos de transtorno de ansiedade, só que eles funcionam com alguma espécie de gatilho, e esse mesmo pode ser tanto alguma coisa quanto alguma situação específica, alguns exemplos mais famosos são a claustrofobia (medo de ambientes apertados ou fechados), aracnofobia (medo de aranhas) e a fobia social (medo de interagir com outras pessoas). <br>\r\n-Síndrome do pânico: A síndrome do pânico é caracterizada principalmente por conta das crises que podem acontecer em qualquer momento do dia, com uma forte sensação de medo e mal-estar que pode durar de 15 a 30 minutos.\r\n'),
(4, 'Autismo', '<p style=\"color:red\">É IMPORTANTE ENFATIZAR A PROCURA POR ESPECIALISTAS E PROFISSIONAIS NA ÁREA, CASO VOCÊ SINTA QUALQUER DOS SINTOMAS, PROCURE UM PROFISSIONAL PRÓXIMO.</p>\r\n\r\n<p>Um dos transtornos mais conhecidos pela população em geral é o Transtorno do Espectro Autista (TEA), ou simplesmente Autismo. Porém infelizmente as pessoas acham que conhecem tudo sobre esse distúrbio, quando na verdade elas conhecem apenas um pouco ou até mesmo nada, e assim acabam caindo na própria ignorância. </p>\r\n<p>As características principais desse distúrbio são a falta de habilidade social e a dificuldade extrema de se comunicar tanto de forma verbal quanto de forma não verbal, e isso afeta diretamente no aprendizado da fala da criança, se tornando cada vez mais tardio se não for procurada a ajuda de um profissional. Diferente do que muitas pessoas pensam, o Autismo afeta unicamente a capacidade social das pessoas, e o desenvolvimento físico de um autista é igual ao de uma pessoa sem o distúrbio. </p>\r\n<p>Os primeiros sintomas podem ser identificados desde os primeiros meses de vida da criança, esses sendo:<br>\r\n-Não fazendo contato visual direto com nem mesmo os seus pais; <br>\r\n-Na hora da amamentação, o recém-nascido não olha para sua mãe; <br>\r\n-A criança não olha para um ponto fixo em específico; <br>\r\n-Agressividade; <br>\r\n-A criança não responde aos chamados; <br>\r\n-Inquietação e movimentos pendulares e repetitivos de tronco. </p>\r\n<p>O TEA pode ser causado por predisposição genética, mas estudos dizem que além disso, outros fatores que podem acabar por gerar essa má formação estão ligados ao comportamento da mãe durante a gestação, como a ingestão de bebidas alcoólicas e exposição a produtos tóxicos. As chances da criança nascer com esse transtorno também são maiores caso a mãe pegue alguma infecção durante o período de gestação. </p>\r\n'),
(6, 'Bulimia', '<p style=\"color:red\">É IMPORTANTE ENFATIZAR A PROCURA POR ESPECIALISTAS E PROFISSIONAIS NA ÁREA, CASO VOCÊ SINTA QUALQUER DOS SINTOMAS, PROCURE UM PROFISSIONAL PRÓXIMO.<p>\r\n\r\nA bulimia é um distúrbio alimentar que é caracterizado por episódios de consumo extremamente elevado e incontrolado de alimentos com alto teor calórico, seguidos de uma sensação de culpa, fazendo o sujeito ter reações inadequadas para evitar o ganho desse peso, como a indução de vômitos, ingestão de laxantes, jejum prolongado e atividade física excessiva e exaustiva. <br><br>\r\nDiferente do que muitas pessoas pensam, os sujeitos com bulimia normalmente não apresentam um corpo extremamente magro como o das pessoas anoréxicas, mas normalmente podem apresentar até mesmo um corpo atlético, porém, por conta de dietas rigorosas para manter o seu corpo, acabam se culpando mais quando quebram a mesma, assim levando ao vômito forçado. Essa reação inadequada provoca várias complicações no organismo, como: Destruição do esmalte dos dentes, inflamação na garganta, sangramentos, problemas gastrintestinais, arritmias cardíacas e desidratação. <br><br>\r\nA bulimia pode ser acompanhada de outros transtornos mentais, como TOC, Depressão e o TAG. <br><br>\r\nNormalmente esses episódios podem começar a aparecer depois de algum evento impactante na vida do paciente, como um luto ou até mesmo uma mudança muito brusca no estilo de vida. Essas características também podem aparecer por herança genética, onde a mãe era bulímica e a filha acaba herdando isso da mãe.\r\n'),
(7, 'Déficit de Atenção', '<p style=\"color:red\">É IMPORTANTE ENFATIZAR A PROCURA POR ESPECIALISTAS E PROFISSIONAIS NA ÁREA, CASO VOCÊ SINTA QUALQUER DOS SINTOMAS, PROCURE UM PROFISSIONAL PRÓXIMO. </p>\r\n\r\n<p>TDAH (Transtorno de Déficit de Atenção e Hiperatividade) é um distúrbio neurobiológico crônico que se caracteriza pela dificuldade de concentração, desassossego e impulsividade. Essas características normalmente começam a se manifestar na infância, mas pode perdurar pela vida inteira caso esse problema não seja reconhecido e nem tratado. É possível notar algumas características já na escola, quando um aluno tem alguma dificuldade em alguma atividade proposta, e estando sempre inquieto e nunca focando em algo. </p>\r\n<p>O TDAH não é uma doença nova, e já no século XIX tinham pessoas comentando e escrevendo sobre, porém o estigma em cima desse transtorno ainda é muito grande, e muitas pessoas negam a existência desse problema e dizem que é apenas “frescura”, assim apenas atrasando o tratamento e piorando cada vez mais esse problema. </p>\r\n<p>Algumas prováveis causas que podem influenciar no desenvolvimento desse transtorno são: </p><br>\r\n<p>-Predisposição genética; </p><br>\r\n<p>-Ingestão de substâncias tóxicas ou alcoólicas durante o período de gestação; </p><br>\r\n<p>-Sofrimento fetal; </p><br>\r\n<p>-Problemas familiares. </p><br>\r\n<p>Normalmente, os problemas de hiperatividade diminuem na fase adulta, porém os sintomas relacionados a falta de atenção continuam presentes, sempre se distraindo com facilidade, isso afeta diretamente na vida tanto social quanto na vida profissional do indivíduo. Na adolescência, os portadores desse distúrbio tem uma tendência maior ao uso abusivo de álcool e de drogas. </p>\r\n'),
(9, 'Depressão', '<p style=\"color:red\">É IMPORTANTE ENFATIZAR A PROCURA POR ESPECIALISTAS E PROFISSIONAIS NA ÁREA, CASO VOCÊ SINTA QUALQUER DOS SINTOMAS, PROCURE UM PROFISSIONAL PRÓXIMO.</p>\r\n\r\nTambém conhecida como “O mal do século”, a Depressão é o transtorno mental mais conhecido e um dos mais controversos, por conta de seu perigo e infelizmente pelo se número de vítima nos últimos anos, porém não é nada impossível de se tratar e já é algo comum, mas antes de tudo, precisamos entender o que é esse transtorno.<br><br>\r\n\r\nPoucas pessoas sabem, mas a depressão tem diversos subtipos, sendo que cada um afeta de forma diferente a mente da pessoa. <br>\r\nDistimia: É uma forma crônica da Depressão, também sendo mais leve do que as outras, os seus principais sintomas são os mesmos da forma mais conhecida, porém com menor risco. É um subtipo extremamente frequente nas pessoas, onde pode ser desenvolvido por diversos fatores, principalmente caso você já tenha algum outro transtorno, como ansiedade, fobias etc. Muitas pessoas que acabam por ter distimia, não sabem e nem procuram saber se tem mesmo, por conta de ser menos grave, elas acreditam que isso é algo natural e faz parte da sua personalidade, e por conta desse questionamento e por as vezes não gostar dessas características, as pessoas podem acabar desenvolvendo algo conhecido como depressão dupla, que é quando além dessa depressão crônica e mais leve, ela pode ter episódios da depressão maior. <br><br>\r\nA distimia também pode ser dividida em duas, caso seja desenvolvida antes dos 21 anos, podemos chamar ela de distimia de início precoce, e depois dessa mesma idade, distimia de início tardio. <br>\r\n\r\nDepressão endógena: É uma categoria que se caracteriza principalmente por ser mais eficaz de manhã e fazendo a pessoa perder o interesse nas coisas que antes eram agradáveis e que cativavam essa pessoa, grandes problemas com rejeição etc. <br>\r\n\r\nDepressão Atípica: Também conhecida como “depressão sorridente”, esse subtipo acaba por ser um dos mais difíceis de se identificar, pois diferente dos sintomas normais da depressão, nesse você vê a pessoa sorrindo, é comum ver a pessoa sentindo e transmitindo felicidade<br><br>\r\n\r\nDepressão Sazonal: Nesse tipo de depressão, os sintomas só aparecem em épocas específicas do ano, normalmente nas estações de Outono e Inverno. Especialistas dizem que isso acontece por conta da menor quantidade de luz do sol nessas épocas, assim o corpo acaba recebendo menos serotonina e o corpo não consegue regular esses hormônios, assim causando a depressão. <br><br>\r\n\r\nDepressão Psicótica: Uma forma mais rara de depressão, onde o paciente além de apresentar sintomas depressivos comuns, ele também apresenta sintomas psicóticos, como delírios e alucinações que afetam todos os cinco sentidos do corpo humano. Assim afetando a sanidade da pessoa, fazendo ela não saber direito o que é real e o que não é. O tratamento normalmente é feito com o uso de antidepressivos e antipsicóticos. <br><br>\r\n\r\nDepressão Secundária: A depressão secundária é causada normalmente por conta de alguma outra doença medico-sistêmica ou por uso de algum medicamento. Ela trás uma alta labilidade de humor e deficits cognitivos em seus pacientes, e como principais sintomas temos a apatia, o prejuízo cognitive e a lentificação psicomotora. Normalmente os pacientes que sofrem de depressão secundária tem uma tendência maior de sofrer algum infarto. <br><br>\r\n\r\nDepressão Bipolar:A depressão bipolar se manifesta junto com o transtorno bipolar. extremamente semelhante a versão convencional da depressão, sendo caracterizada pelo fato de que os sintomas depressivos só são notáveis durante os episódios do transtorno bipolar. Os sintomas em geral são os mesmos da depressão unipolar.\r\n\r\n\r\n\r\n'),
(11, 'Esquizofrenia', '<p style=\"color:red\">É IMPORTANTE ENFATIZAR A PROCURA POR ESPECIALISTAS E PROFISSIONAIS NA ÁREA, CASO VOCÊ SINTA QUALQUER DOS SINTOMAS, PROCURE UM PROFISSIONAL PRÓXIMO. </p>\r\n<p>Esquizofrenia, também conhecida como distúrbio da mente dividida, é uma doença psicológica que atinge cerca de 1% da população brasileira.  É marcada por episódios onde a pessoa acaba delirando e tendo diversas alucinações, perdendo completamente a noção do que é real e do que não é. Além disso, os esquizofrênicos estão constantemente com a sensação de que alguém está perseguindo-os. </p>\r\n<br>Diferente do que muitas pessoas pensam, pessoas que sofrem de esquizofrenia não são violentas, o que pode acontecer é uma tentativa de defesa da parte do esquizofrênico para a pessoa que está supostamente “seguindo” ele. <br>\r\nAlguns sinais de esquizofrenia já podem aparecer desde a infância, sendo estes: <br>\r\n\r\n-Dificuldade no aprendizado;<br>\r\n-Apatia;<br>\r\n-Pouca vontade de estudar ou interagir com outras crianças;<br>\r\n-Relatos de vozes que surgem na cabeça.<br>\r\n\r\n<p>As pessoas esquizofrênicas normalmente entendem dos problemas que elas enfrentam e admitem que o que elas veem não é real, porém durante os episódios desse distúrbio, as alucinações podem afetar tanto o indivíduo que ele perde totalmente a noção do que é real, assim a pessoa fica extremamente agitada. Em momentos como esse, deve-se confortar a pessoa e entender que o que ela está vendo é real para ela, e não a questionar no momento, apenas aguardar o surto acabar. </p>\r\n<p>A esquizofrenia é uma doença progressiva, ou seja, quanto maior for a demora para procurar um profissional e começar um tratamento, maior vai ser o número e a intensidade dos surtos. </p>\r\n'),
(14, 'Psicose', '<p style=\"color:red\">É IMPORTANTE ENFATIZAR A PROCURA POR ESPECIALISTAS E PROFISSIONAIS NA ÁREA, CASO VOCÊ SINTA QUALQUER DOS SINTOMAS, PROCURE UM PROFISSIONAL PRÓXIMO.</p>\r\nTranstorno Psicótico, ou apenas psicose, é um transtorno mental muito semelhante a esquizofrenia, sendo as principais diferenças a duração de um surto delirante, que na psicose pode ir de no mínimo um dia até mesmo um mês, e a presença de alguns outros sintomas, como:<br><br>\r\n-Mudança repentina de humor; <br>\r\n-Dificuldade de concentração; <br>\r\n-Alucinações e delírios; <br>\r\n-Discurso desorganizado, sempre mudando o assunto de forma imprevisível. <br>\r\nExistem três tipos de psicose, todos caracterizados pela sua causa, sendo eles: <br><br>\r\n-Transtorno Psicótico Breve: É a forma mais leve desse distúrbio, aparecendo em momentos de grande estresse pessoal, como término de um relacionamento, pós-parto, morte de um ente querido etc. Pessoas com esse quadro psicótico normalmente só permanecem com ele por um curto período de até no máximo um mês, desde que esse procure ajuda, a recuperação tende a ser rápida; <br><br>\r\n-Transtorno Psicótico induzido por substâncias ou medicamentos: Algumas substâncias tóxicas ou medicamentos que ao ingerir, acabam por gerar sintomas psicóticos, esses também podem ser chamados de alucinógenos, e algumas pessoas acabam se tornando dependentes do uso deles, e ao parar, começam a surgir sintomas psicóticos por conta dessa abstinência; <br><br>\r\n-Transtorno Psicótico Orgânico: Nesse caso, os sintomas só começam a aparecer depois de alguma lesão cerebral ou infecção que afeta o cérebro.\r\n'),
(15, 'Síndrome de Tourette', '<p style=\"color:red\">É IMPORTANTE ENFATIZAR A PROCURA POR ESPECIALISTAS E PROFISSIONAIS NA ÁREA, CASO VOCÊ SINTA QUALQUER DOS SINTOMAS, PROCURE UM PROFISSIONAL PRÓXIMO. </p>\r\nA Síndrome de Tourette é um distúrbio neuropsiquiátrico caracterizado por atos involuntários, impulsivos, frequentes e repetitivos, esses também conhecidos como tiques. Esses tiques acontecem tanto de forma verbal quanto de forma motora, sendo os tiques mais conhecidos: <br>\r\nTiques motores: <br>\r\n-Piscar os olhos; <br>\r\n-Inclinar a cabeça; <br>\r\n-Encolher os ombros; <br>\r\n-Tocar no nariz; <br>\r\n-Fazer caretas; <br>\r\n-Gestos obscenos; <br>\r\n-Chutes; <br>\r\n-Bater no peito; <br>\r\n-Sacudir o pescoço. <br>\r\n\r\nTiques vocais: <br>\r\n-Xingamentos; <br>\r\n-Soluçar; <br>\r\n-Gritar; <br>\r\n-Cuspir; <br>\r\n-Cacarejar; <br>\r\n-Gemer; <br>\r\n-Uivar; <br>\r\n-Limpar a garganta; <br>\r\n-Repetir palavras ou frases; <br>\r\n-Usar diferentes tons de voz. <br>\r\n\r\nAinda não existem muitas causas específicas para doença, porém a predisposição genética é um fator que pode sim influenciar no desenvolvimento neurológico da criança. Esses sintomas já podem ser observados no indivíduo desde os primeiros anos de vida, onde a criança já apresenta alguns tiques simples como franzir a testa e piscar de forma exagerada, e caso seja percebido algum desses tiques, é recomendado procurar um profissional o quanto antes. <br>\r\nA intensidade dos tiques pode aumentar de acordo com o nível de estresse da pessoa. Infelizmente, não existe uma cura para esse distúrbio, porém ao procurar um psicólogo e recebendo o tratamento adequado, a tendência é que os tiquem venham a diminuir no paciente. <br>\r\n'),
(18, 'TOC', '<p style=\"color:red\">É IMPORTANTE ENFATIZAR A PROCURA POR ESPECIALISTAS E PROFISSIONAIS NA ÁREA, CASO VOCÊ SINTA QUALQUER DOS SINTOMAS, PROCURE UM PROFISSIONAL PRÓXIMO.</p>\r\n\r\n<p>Transtorno Obsessivo Compulsivo (ou simplesmente TOC), é um transtorno mental que atinge cerca de 8 milhões de brasileiros e, diferente de que muitas pessoas pensam, TOC é um transtorno sério que atrapalha muito a vida de quem sofre disso, fazendo os indivíduos ficarem presos por muito tempo em costumes ou manias que dificultam a sua vida tanto social quanto profissional.</p>\r\n<p>Mas como funciona o TOC? Primeiro devemos entender o que é uma obsessão e o que é compulsão:</p>\r\n<p>-Obsessão: Apego exagerado a alguma ideia ou sentimento. Ex: Tudo que não é seu está repleto de germes, logo precisa sempre lavar a mão depois de encostar em algo de outra pessoa;</p>\r\n<p>-Compulsão: É a realização física sem controle da obsessão, sendo feita com uma intensidade e quantidade exagerada. Ex: Lavar a mão sempre que encostar em alguma coisa de outra pessoa.</p>\r\n<p>É normal ter costumes e manias, porém o que difere o TOC das manias comuns é a intensidade em que ela é realizada. Uma pessoa com esse transtorno pode ficar horas fazendo a mesma coisa e, normalmente, pessoas com TOC sentem uma sensação de morte ou de que algo ruim vai acontecer caso não realize esse “ritual”. Alguns exemplos são voltar um caminho todo para confirmar se todas as fechaduras estão trancadas ou deixar de trabalhar para limpar tudo na sua casa. Também podemos caracterizar como TOC quando o problema começa a afetar outras partes da sua vida.</p>\r\n<p>Normalmente as “manias” se desenvolvem nas áreas da limpeza, checagem, contagem, organização, simetria, colecionismo e podem variar ao longo da evolução desse transtorno.</p>\r\n'),
(19, 'Transtorno de bipolaridade', '<p style=\"color:red\">É IMPORTANTE ENFATIZAR A PROCURA POR ESPECIALISTAS E PROFISSIONAIS NA ÁREA, CASO VOCÊ SINTA QUALQUER DOS SINTOMAS, PROCURE UM PROFISSIONAL PRÓXIMO.</p>\r\nTranstorno Afetivo Bipolar (TAB), ou simplesmente Transtorno Bipolar, é um transtorno psiquiátrico que afeta a vida de milhões de pessoas no mundo inteiro. Como o nome já diz, esse transtorno é caracterizado por ter dois polos opostos, sendo eles o de um humor depressivo e o outro um humor eufórico. Muitas vezes visto como piada na sociedade, a vida das pessoas que sofrem desse transtorno não é fácil e esse problema deve ser visto de forma séria. As principais características dos polos são: <br>\r\nPolo depressivo: humor deprimido, tristeza profunda, apatia, desinteresse por atividades antes prazerosas, isolamento social, alterações de sono e de apetite, redução da libido, cansaço, dificuldade de concentração, culpa excessiva, frustração e ideias suicidas; <br>\r\nPolo Eufórico (Mania): autoestima e autoconfiança elevada, pouca sensação de sono, agitação psicomotora, dificuldade ao coordenar ideias, desvio de atenção, compulsão para falar, libido elevada, impaciência e comportamento agressivo. Normalmente nessa fase, o paciente acaba por tomar atitudes que podem comprometer o mesmo, como demissão de emprego e gasto descontrolado de dinheiro. <br>\r\n\r\nTambém existe um outro polo chamado de Hipomania, esse tendo as mesmas características da mania, com a única diferença sendo a menor intensidade. <br>\r\nUma pessoa com Transtorno bipolar pode ficar de um dia a uma semana com um polo específico. <br>\r\nAlguns fatores envolvidos no desenvolvimento desse transtorno são a predisposição genética e alterações em certas áreas do cérebro. <br>\r\n\r\n'),
(20, 'Transtorno de personalidade', '<p style=\"color:red\"> É IMPORTANTE ENFATIZAR A PROCURA POR ESPECIALISTAS E PROFISSIONAIS NA ÁREA, CASO VOCÊ SINTA QUALQUER DOS SINTOMAS, PROCURE UM PROFISSIONAL PRÓXIMO.</p>\r\n<p>Personalidade é algo que pode ser construído ao longo do tempo, e está sempre adaptada e mantida pela pessoa, porém essa regra não se aplica a pessoas com o Transtorno de personalidade. </p>\r\n<p>O Transtorno de personalidade é caracterizado por um padrão de comportamento mal adaptativo, extremamente enraizado e inflexível, reações inusitadas de situações emocionais e formas de relacionamento social. Portanto, existem diversos tipos de transtornos de personalidade, esses podendo ser agrupados em três grupos entre si, sendo eles: </p>\r\n\r\nGrupo A (ou transtornos excêntricos ou estranhos): <br>\r\n<p>Transtorno de personalidade paranoide: Um padrão de desconfiança e suspeita de tudo e todos, acreditando que todos estão planejando algo contra o indivíduo; </p>\r\n<p>Transtorno de personalidade esquizoide: Padrão de distanciamento de relações sociais e falta de expressão emocional; </p>\r\n<p>Transtorno de personalidade esquizóptica: Um padrão de desconforto agudo em relações íntima, distorções cognitivas e excentricidade do comportamento. </p>\r\n\r\nGrupo B (ou transtornos dramáticos, imprevisíveis ou irregulares):<br>\r\n<p>Transtorno da personalidade antissocial (Sociopatia): é um padrão de desrespeito e violação dos direitos dos outros, também conhecida como sociopatia. Normalmente pessoas sociopatas tem uma tendência maior à “falsidade”, mentem muito e usam trapaças ou até mesmo a violência para conseguirem o que querem; </p>\r\n<p>Transtorno da personalidade borderline: é um padrão de instabilidade nas relações sociais, na autoimagem e nos afetos, sempre reagindo de forma extrema; </p>\r\n<p>Transtornos da personalidade histriônica: É um padrão de alto nível de emocionalidade e busca por atenção em excesso; </p>\r\n<p>Transtornos da personalidade narcisista: Padrão de grandiosidade, necessidade de admiração e falta de empatia. </p><br>\r\n\r\n<p>Grupo C (ou transtornos ansiosos ou receosos):</p>\r\n<p>Transtorno da personalidade esquiva ou evitativa: É um padrão de inibição social, medo de não se adequar na sociedade. Não conseguem lidar com avaliações negativas; </p> \r\n<p>Transtorno da personalidade obsessivo-compulsiva: Semelhante ao TOC, se preocupa muito com a ordem e perfeccionismo das coisas; </p>\r\n<p>Transtorno da personalidade dependente: Necessidade de ser cuidado por alguém, medo de estar sozinho e dificuldade de se separar dos entes e tomar decisões por conta própria. </p>\r\n'),
(21, 'Tricotilomania', '<p style=\"color:red\">É IMPORTANTE ENFATIZAR A PROCURA POR ESPECIALISTAS E PROFISSIONAIS NA ÁREA, CASO VOCÊ SINTA QUALQUER DOS SINTOMAS, PROCURE UM PROFISSIONAL PRÓXIMO.</p>\r\nTricotilomania é um distúrbio mental que faz com que o indivíduo tenha um desejo incontrolável de arrancar cabelos e pelos de seu corpo, podendo passar mal caso esse desejo não seja cumprido. A pressão é tanta para arrancar o pelo que quando o paciente arranca o mesmo, o cérebro libera um hormônio específico causando para a pessoa essa sensação de recompensa.<br><br>\r\nNormalmente, as pessoas com tricotilomania apresentam falhas capilares no seu couro cabeludo e no resto do corpo, essas mesmas falhas que causam uma sensação de vergonha e constrangimento nos pacientes, assim eles acabam por usar roupas maiores, chapéus ou até mesmo perucas para esconder essas falhas. <br><br>\r\nA Tricotilomania começa a aparecer com mais frequência na pré-adolescência, entre os 11 e 15 anos, onde começam a crescer pelos pubianos e por questão de estética acabam arrancando e assim esse ciclo vicioso continua. Outros hábitos de automutilação que pessoas com esse transtorno apresentam são roer as unhas e cutucar cutículas. <br>. <br>\r\n\r\nEsse transtorno pode acabar levando a outro chamado de tricofagia, que é caracterizado pela ingestão de cabelos. Sintomas característicos de pessoas com tricofagia são: <br>\r\n-Náuseas e vômitos. <br>\r\n-Dores abdominais; <br>\r\n-Perda de apetite; <br>\r\n-Bloqueios intestinais. <br>\r\n\r\nNão existem causas certas para esse distúrbio, mas alguns estudos já comprovam que a genética familiar pode sim estar envolvida nisso. <br>\r\n');

-- --------------------------------------------------------

--
-- Estrutura da tabela `nivel_de_usuario`
--

CREATE TABLE `nivel_de_usuario` (
  `cd_level` int(11) NOT NULL,
  `nm_level` varchar(80) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Extraindo dados da tabela `nivel_de_usuario`
--

INSERT INTO `nivel_de_usuario` (`cd_level`, `nm_level`) VALUES
(1, 'Profissional'),
(2, 'Comum');
...
INSERT INTO `tb_cidade` (`cd_cidade`, `nm_nome`, `id_UF`) VALUES
(1, 'Afonso Cláudio', 8),
...
CREATE TABLE `tb_comentario` (
  ...
  `cd_user_comentario` int(11) NOT NULL,
  `tx_comentario` text NOT NULL,
  `cd_post_forum` int(11) NOT NULL,
  `dt_data_comentario` varchar(500) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `tb_forum` (
  ...
  `cd_user_post` int(11) NOT NULL,
  `tx_post` text NOT NULL,
  `cd_transtorno` int(11) NOT NULL,
  `num_like` int(255) NOT NULL,
  `dt_data_post` varchar(500) NOT NULL,
  `titulo_texto` varchar(500) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

-- --------------------------------------------------------

--
-- Estrutura da tabela `tb_like`
--

CREATE TABLE `tb_like` (
  `cd_like` int(11) NOT NULL,
...
--
-- Estrutura da tabela `tb_transtornosmentais`
--

CREATE TABLE `tb_transtornosmentais` (
  `cd_transtorno` int(11) NOT NULL,
  `nm_transtorno` varchar(100) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Extraindo dados da tabela `tb_transtornosmentais`
--

INSERT INTO `tb_transtornosmentais` (`cd_transtorno`, `nm_transtorno`) VALUES
(2, 'Anorexia'),
(3, 'Ansiedade'),
(4, 'Autismo'),
(6, 'Bulimia'),
...
CREATE TABLE `tb_uf` (
  ...
  `nm_nome` varchar(75) DEFAULT NULL,
...
INSERT INTO `tb_uf` (`cd_UF`, `nm_nome`, `uf`) VALUES
(1, 'Acre', 'AC'),
(2, 'Alagoas', 'AL'),
(3, 'Amazonas', 'AM'),
(4, 'Amapá', 'AP'),
...
CREATE TABLE `tb_usuario` (
  ...
  `localização` int(30) NOT NULL,
  `foto` varchar(150) DEFAULT NULL,
  `telefone` varchar(15) NOT NULL,
  `nv_user` int(10) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Índices para tabela `conteudodaspaginas`
--
ALTER TABLE `conteudodaspaginas`
  ADD PRIMARY KEY (`cd_conteudo`);

--
-- Índices para tabela `nivel_de_usuario`
--
ALTER TABLE `nivel_de_usuario`
  ADD PRIMARY KEY (`cd_level`);
...
ALTER TABLE `tb_cidade`
  ...
  ADD KEY `fk_tb_cidade_tb_uf` (`id_UF`);
...
ALTER TABLE `tb_comentario`
  ...
  ADD KEY `fk_tb_forum_tb_comentario` (`cd_post_forum`),
  ADD KEY `fk_tb_usuario_tb_comentario` (`cd_user_comentario`);
...
ALTER TABLE `tb_forum`
  ...
  ADD KEY `fk_tb_usuario_tb_forum` (`cd_user_post`),
  ADD KEY `fk_tb_transtornosmentais_tb_forum` (`cd_transtorno`);

--
-- Índices para tabela `tb_like`
--
ALTER TABLE `tb_like`
  ADD PRIMARY KEY (`cd_like`),
  ADD KEY `fk_tb_usuario_tb_like` (`id_usuario`),
  ADD KEY `fk_tb_forum_tb_like` (`id_post`);

--
-- Índices para tabela `tb_transtornosmentais`
--
ALTER TABLE `tb_transtornosmentais`
  ADD PRIMARY KEY (`cd_transtorno`);
...
ALTER TABLE `tb_usuario`
  ...
  ADD KEY `fk_tb_usuario_tb_cidade` (`localização`),
  ADD KEY `fk_tb_usuario_tb_nivel_de_usuario` (`nv_user`);
...
--
-- AUTO_INCREMENT de tabela `conteudodaspaginas`
--
ALTER TABLE `conteudodaspaginas`
  MODIFY `cd_conteudo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;

--
-- AUTO_INCREMENT de tabela `nivel_de_usuario`
--
ALTER TABLE `nivel_de_usuario`
  MODIFY `cd_level` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `tb_forum`
  MODIFY `cd_post` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT de tabela `tb_like`
--
ALTER TABLE `tb_like`
  MODIFY `cd_like` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT de tabela `tb_transtornosmentais`
--
ALTER TABLE `tb_transtornosmentais`
  MODIFY `cd_transtorno` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
...
--
ALTER TABLE `tb_cidade`
  ADD CONSTRAINT `fk_tb_cidade_tb_uf` FOREIGN KEY (`id_UF`) REFERENCES `tb_uf` (`cd_UF`);

--
-- Limitadores para a tabela `tb_comentario`
--
ALTER TABLE `tb_comentario`
  ADD CONSTRAINT `fk_tb_forum_tb_comentario` FOREIGN KEY (`cd_post_forum`) REFERENCES `tb_forum` (`cd_post`),
  ADD CONSTRAINT `fk_tb_usuario_tb_comentario` FOREIGN KEY (`cd_user_comentario`) REFERENCES `tb_usuario` (`cd_usuario`);

--
-- Limitadores para a tabela `tb_forum`
--
ALTER TABLE `tb_forum`
  ADD CONSTRAINT `fk_tb_transtornosmentais_tb_forum` FOREIGN KEY (`cd_transtorno`) REFERENCES `tb_transtornosmentais` (`cd_transtorno`),
  ADD CONSTRAINT `fk_tb_usuario_tb_forum` FOREIGN KEY (`cd_user_post`) REFERENCES `tb_usuario` (`cd_usuario`);

--
-- Limitadores para a tabela `tb_like`
--
ALTER TABLE `tb_like`
  ADD CONSTRAINT `fk_tb_forum_tb_like` FOREIGN KEY (`id_post`) REFERENCES `tb_forum` (`cd_post`),
  ADD CONSTRAINT `fk_tb_usuario_tb_like` FOREIGN KEY (`id_usuario`) REFERENCES `tb_usuario` (`cd_usuario`);

--
-- Limitadores para a tabela `tb_usuario`
--
ALTER TABLE `tb_usuario`
  ADD CONSTRAINT `fk_tb_usuario_tb_cidade` FOREIGN KEY (`localização`) REFERENCES `tb_cidade` (`cd_cidade`),
  ADD CONSTRAINT `fk_tb_usuario_tb_nivel_de_usuario` FOREIGN KEY (`nv_user`) REFERENCES `nivel_de_usuario` (`cd_level`);
COMMIT;
